...
def main():
    ...
    TRAIN_CSV = script_dir / '../../data/train_data/kurtis_train.csv'
    VAL_CSV = script_dir / '../../data/val_data/kurtis_val.csv'
    ...
    combined_embeddings_path = combined_embeddings_path = script_dir / 'word_embeddings/kurtis_embeddings.json'
    ...
    save_dir = script_dir / '../../kurtis/models'
    ...
    for epoch in range(num_epochs):
        ...
        if avg_val_f1 > best_val_f1:
            ...
            torch.save({
                ...
                'val_f1': best_val_f1
            }, save_dir / 'kurtis_visual_text_combined_best.pth')
    ...
    torch.save({
        ...
        'attribute_weights': current_weights,
        'val_f1': avg_val_f1
    }, save_dir / 'kurtis_visual_text_combined_final.pth')
