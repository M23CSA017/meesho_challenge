...
if __name__ == "__main__":
    ...
    attribute_values = {
        "attr_1": ["black", "navy blue", "red", "default", "maroon", "white", "green", "blue", "pink", "yellow", "peach", "multicolor"],
        "attr_2": ["regular", "fitted", "boxy", "default"],
        "attr_3": ["crop", "regular"],
        "attr_4": ["high", "round neck", "stylised", "sweetheart neck", "v-neck", "square neck", "default"],
        "attr_5": ["casual", "party"],
        "attr_6": ["default", "printed", "solid"],
        "attr_7": ["solid", "typography", "graphic", "default", "quirky", "floral"],
        "attr_8": ["short sleeves", "sleeveless", "three-quarter sleeves", "long sleeves"],
        "attr_9": ["regular sleeves", "default", "sleeveless", "puff sleeves"],
        "attr_10": ["knitted", "default", "ruffles", "waist tie-ups", "tie-ups", "applique"]
    }

    output_path = "word_embeddings/tops_tunics_embeddings.json"
